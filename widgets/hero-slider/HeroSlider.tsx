...
const heroSlides: HeroSlide[] = [
  {
    ...
    description: 'Discover the latest in tech with our premium electronics collection. From smartphones to laptops, find everything you need.',
    image: 'https://picsum.photos/1200/600?random=hero1',
    ctaText: 'Shop Electronics',
    ctaLink: '/catalog?category=electronics',
    badge: 'Limited Time',
  },
  {
    id: '2',
    ...
    description: 'Step into style with our latest fashion collection. From casual wear to formal attire, express your unique style.',
    image: 'https://picsum.photos/1200/600?random=hero2',
    ctaText: 'Explore Fashion',
    ctaLink: '/catalog?category=clothing',
  },
  {
    id: '3',
    title: 'Home & Living',
    subtitle: 'Transform Your Space',
    description: 'Create the perfect home with our curated selection of furniture, decor, and home essentials.',
    image: 'https://picsum.photos/1200/600?random=hero3',
    ctaText: 'Shop Home',
    ctaLink: '/catalog?category=home-garden',
    badge: 'Free Shipping',
  },
];
